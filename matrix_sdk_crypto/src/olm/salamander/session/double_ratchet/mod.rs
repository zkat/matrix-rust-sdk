...
pub use messages::{OlmMessage, PrekeyMessage};
pub use ratchet::RemoteRatchetKey;
pub use root_key::{RemoteRootKey, RootKey};
pub use shared_secret::{RemoteShared3DHSecret, Shared3DHSecret};

pub enum LocalDoubleRatchet {
...
pub struct InactiveDoubleRatchet {
...
pub struct RemoteDoubleRatchet {
